...
PROMPT="$POWERLINE_SEC1_BG$POWERLINE_SEC1_TXT $POWERLINE_USER_NAME %k%f$POWERLINE_SEC1_FG%K{$POWERLINE_PATH_BG}"$'\ue0b0'"%k%f%F{white}%K{$POWERLINE_PATH_BG} "$POWERLINE_CURRENT_PATH"%F{$POWERLINE_PATH_BG}"$POWERLINE_GIT_INFO_LEFT" %k"$'\ue0b0'"%f "

...
if [ "$POWERLINE_PATH_FG" = "" ]; then
  POWERLINE_PATH_FG="254"
fi
if [ "$POWERLINE_PATH_BG" = "" ]; then
  POWERLINE_PATH_BG="blue"
fi
...
PROMPT="$POWERLINE_SEC1_BG$POWERLINE_SEC1_TXT $POWERLINE_USER_NAME %k%f$POWERLINE_SEC1_FG%K{$POWERLINE_PATH_BG}"$'\ue0b0'"%k%f%F{$POWERLINE_PATH_FG}%K{$POWERLINE_PATH_BG} "$POWERLINE_CURRENT_PATH"%F{$POWERLINE_PATH_BG}"$POWERLINE_GIT_INFO_LEFT" %k"$'\ue0b0'"%f "
